...
legend_text = (
    ...
    "<span style='font-size:26px; font-style:italic;'>Classification based on standardized Mahalanobis distance</span><br>"
    "<span style='font-size:26px; font-style:italic;'>using a diagonal covariance matrix</span><br><br>"
